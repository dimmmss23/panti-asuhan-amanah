    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
            ...
            <main className="flex-grow pt-16">
                ...
                <div className="relative w-full py-20 md:py-28 overflow-hidden bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-800">
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 relative z-10 pb-16 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {/* Email */}
                        <Link href="mailto:yayasanpantiasuhanamanah@gmail.com" className="relative bg-white rounded-xl border border-gray-100 overflow-hidden hover:border-green-200 transition-all duration-300 group">
                        ...
                        {/* WhatsApp */}
                        <Link href="https://wa.me/6282180458885" target="_blank" className="relative bg-white rounded-xl border border-gray-100 overflow-hidden hover:border-green-200 transition-all duration-300 group">
                    ...
                    <div className="pt-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            {/* Tanya Jawab */}
                            <Link href="/faq" className="group relative bg-white rounded-xl p-6 border border-green-200 md:border-gray-100 md:hover:border-green-200 transition-all duration-300 overflow-hidden">
                                <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-green-500 to-emerald-500" />
                            ...
                            {/* Syarat & Ketentuan */}
                            <Link href="/syarat-ketentuan" className="group relative bg-white rounded-xl p-6 border border-green-200 md:border-gray-100 md:hover:border-green-200 transition-all duration-300 overflow-hidden">
                                <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-green-500 to-emerald-500" />
                                <div className="w-12 h-12 bg-green-600 text-white md:bg-green-50 md:text-green-600 rounded-lg flex items-center justify-center mb-4 md:group-hover:bg-green-600 md:group-hover:text-white transition-colors">
                                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            {/* Kebijakan Privasi */}
                            <Link href="/kebijakan-privasi" className="group relative bg-white rounded-xl p-6 border border-green-200 md:border-gray-100 md:hover:border-green-200 transition-all duration-300 overflow-hidden">
                                <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-green-500 to-emerald-500" />
                                <div className="w-12 h-12 bg-green-600 text-white md:bg-green-50 md:text-green-600 rounded-lg flex items-center justify-center mb-4 md:group-hover:bg-green-600 md:group-hover:text-white transition-colors">
                                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
