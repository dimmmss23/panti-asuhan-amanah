    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <main className="flex-grow">
                {/* Hero Section */}
                {/* 
                    PANDUAN UKURAN HERO IMAGE (FIXED HEIGHT):
                    Hero section menggunakan ketinggian tetap agar terlihat besar dan jelas.
                    - Mobile: Tinggi 400px
                    - Desktop: Tinggi 500px
                    
                    Desain 'Card Overlap' (-mt-10) akan menutupi bagian bawah gambar.
                    Pastikan FOKUS UTAMA gambar ada di tengah-tengah (Center).
                */}
                ...
                {/* Main Content Card */}
                {/* Restored negative margin (-mt-10) for Mobile to keep the "Card" aesthetic. 
                    Hero is tall enough (400px) so it won't be fully covered. */}
                <div className="container mx-auto px-4 max-w-6xl pb-20">
                    <div className="relative bg-white rounded-3xl shadow-xl -mt-10 md:-mt-16 p-6 md:p-12 border-t border-gray-100 flex flex-col items-center">

                        {/* Floating Logo (The Seal) - Positioned absolute relative to the card */}
                        ...
                        <div className="text-center mt-10 md:mt-16 max-w-4xl mx-auto space-y-6">
                            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-green-800 leading-tight">
                                Yayasan Panti Asuhan Amanah
                            </h1>

                            <p className="text-gray-600 text-base md:text-lg leading-relaxed text-justify md:text-center">
                                ...
                                Melalui sistem pengasuhan asrama yang berbasis kekeluargaan, kami tidak hanya memenuhi kebutuhan dasar, tetapi juga memprioritaskan pendidikan formal berkualitas, pembinaan akhlak mulia, serta pengembangan bakat. Tujuan utama kami adalah memastikan setiap anak asuh tumbuh menjadi pribadi yang sholeh, mandiri, dan siap berprestasi.                            </p>
                        </div>

                        {/* Legalitas (Moved UP below Description) */}
                        <div className="w-full mt-12 max-w-5xl">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                                {[
                                    ...
                                    <div key={index} className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex items-center gap-4">
                        ...
                        <div className="w-full mt-16 grid md:grid-cols-2 gap-6 md:gap-10">
                            {/* Visi Card */}
                            <div className="bg-green-50 rounded-2xl p-6 md:p-8 border border-green-100 flex flex-col items-center text-center hover:bg-green-100 transition-colors duration-300">
                            ...
                            {/* Misi Card */}
                            <div className="bg-orange-50 rounded-2xl p-6 md:p-8 border border-orange-100 flex flex-col items-center text-center hover:bg-orange-100 transition-colors duration-300">
                        ...
                        {/* Struktur Pengurus (Moved Below Visi Misi) */}
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 text-center">
                            {[
                                ...
                                <div key={index} className="p-4 px-2 hover:transform hover:scale-105 transition-transform duration-300">
                ...
                {/* Struktur Pengurus (If you wanted it here originally - kept above as per new request inside the card) */}
                {/* <section className="container mx-auto px-4 mb-16 text-center"> ... </section> */}
