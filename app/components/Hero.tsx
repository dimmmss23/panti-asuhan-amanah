                ...
                <div className="container mx-auto px-3 py-4 sm:py-6 md:py-10 relative z-10">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <Link href="/donasi">
                                <motion.button
                                    className="group relative inline-flex items-center gap-1.5 bg-amber-400 hover:bg-amber-300 text-green-900 font-bold px-4 py-2 sm:px-6 sm:py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-xs sm:text-sm"
